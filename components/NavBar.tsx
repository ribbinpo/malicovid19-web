            ...
            <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
                ...
                <div className="">
                    <ul className="flex flex-row ml-5 mr-auto ">
                        ...
                        <Link href="https://line.me/ti/p/@232supas"><a><li className="px-5 py-1 rounded-full bg-green-500 text-white shadow-md cursor-pointer select-none hover:bg-green-600 ">Join Us</li></a></Link>
                    </ul>
                </div>
            </div>
        </nav>
